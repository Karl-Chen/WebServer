...
public partial class GoodStoreContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CateID).HasName("PK__Category__27638D740B99F724");
        ...
        {
            entity.HasKey(e => e.OrderID).HasName("PK__Order__C3905BAFAC83A11D");
        ...
        {
            entity.HasKey(e => new { e.OrderID, e.ProductID }).HasName("PK__OrderDet__08D097C126353FD9");
        ...
        {
            entity.HasKey(e => e.ProductID).HasName("PK__Product__B40CC6EDD2FA8804");
